...
extern "C" {
	...
	sender PeParser(char* getFileName)
	{
		...
		senderVar.entryPoint = (int*)((unsigned char*)((int*)lpBuffer + senderVar.entryOffset / 4 ) + senderVar.entryOffset % 4); // %4 is important for not divided 4 entrypoint values
